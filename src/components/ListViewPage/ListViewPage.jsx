...
import { AlertCircle, CheckCircle, CheckSquare, Trash} from 'react-feather';
...
function ListViewPage() {
  ...
  const prioritizedData= [].concat(filteredArray).sort((a,b) => a.priorityValue < b.priorityValue ? 1 : -1);
